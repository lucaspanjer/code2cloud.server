 ...
 * 
 */
public class GetProjectTemplatePropertiesResult extends AbstractSimpleResult<List<ProjectTemplateProperty>> {

	protected GetProjectTemplatePropertiesResult() {
		super();
	}

	public GetProjectTemplatePropertiesResult(List<ProjectTemplateProperty> value) {
		super(value);
	}
