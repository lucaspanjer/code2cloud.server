 ...
 * 
 */
public class UpdateOrganizationResult extends AbstractSimpleResult<Organization> {
	public UpdateOrganizationResult() {
		super();
	}

	public UpdateOrganizationResult(Organization value) {
		super(value);
	}
}
