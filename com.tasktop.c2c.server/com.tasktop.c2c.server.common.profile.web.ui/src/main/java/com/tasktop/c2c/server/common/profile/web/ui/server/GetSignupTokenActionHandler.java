 ...
 */
@Component
public class GetSignupTokenActionHandler extends
		AbstractProfileActionHandler<GetSignupTokenAction, GetSignupTokenResult> {

	public GetSignupTokenActionHandler() {
		super();
	}

	@Override
	public GetSignupTokenResult execute(GetSignupTokenAction action, ExecutionContext context) throws DispatchException {
		try {
