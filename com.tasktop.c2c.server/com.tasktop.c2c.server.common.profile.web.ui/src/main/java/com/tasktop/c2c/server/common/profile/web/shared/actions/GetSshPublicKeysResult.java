 ...
 * 
 */
public class GetSshPublicKeysResult extends AbstractSimpleResult<List<SshPublicKey>> {

	protected GetSshPublicKeysResult() {
		super();
	}

	public GetSshPublicKeysResult(List<SshPublicKey> value) {
		super(value);
	}
