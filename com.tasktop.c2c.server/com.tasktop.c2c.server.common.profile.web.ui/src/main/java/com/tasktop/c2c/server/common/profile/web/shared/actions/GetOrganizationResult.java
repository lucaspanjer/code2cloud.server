 ...
 * 
 */
public class GetOrganizationResult extends AbstractSimpleResult<Organization> {

	protected GetOrganizationResult() {
		super();
	}

	public GetOrganizationResult(Organization value) {
		super(value);
	}
