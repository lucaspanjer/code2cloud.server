 ...
 * 
 */
public class GetPendingAgreementsResult extends AbstractSimpleResult<List<Agreement>> {

	protected GetPendingAgreementsResult() {
		super();
	}

	public GetPendingAgreementsResult(List<Agreement> value) {
		super(value);
	}
