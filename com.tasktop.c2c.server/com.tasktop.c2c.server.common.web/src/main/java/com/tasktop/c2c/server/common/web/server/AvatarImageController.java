...
import com.tasktop.c2c.server.common.service.HttpProxySetup;
 ...
 */
@Controller
public class AvatarImageController implements InitializingBean {
	...
	@Autowired
	private HttpProxySetup httpProxySetup;
	...
	public void afterPropertiesSet() throws Exception {
		httpProxySetup.configureHttpClient(client);
	}
}
