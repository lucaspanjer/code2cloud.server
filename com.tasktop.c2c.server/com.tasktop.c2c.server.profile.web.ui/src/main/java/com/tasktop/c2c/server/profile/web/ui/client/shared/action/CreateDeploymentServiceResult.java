 ...
 * 
 */
public class CreateDeploymentServiceResult extends AbstractSimpleResult<CloudService> {

	protected CreateDeploymentServiceResult() {
		super();
	}

	public CreateDeploymentServiceResult(CloudService value) {
		super(value);
	}
