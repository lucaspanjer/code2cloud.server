 ...
 * 
 */
public class DeploymentStatusResult extends AbstractSimpleResult<DeploymentStatus> {

	protected DeploymentStatusResult() {
		super();
	}

	public DeploymentStatusResult(DeploymentStatus value) {
		super(value);
	}
