...
import static com.tasktop.c2c.server.common.web.client.widgets.Format.stringValueDate;
...
public class ModifiedColumn extends TaskColumnDescriptor {

	private TasksMessages tasksMessages = GWT.create(TasksMessages.class);

	@Override
	public String getLabel() {
		return tasksMessages.changed();
	}

	@Override
	public String getTaskField() {
		return TaskFieldConstants.LAST_UPDATE_FIELD;
	}
	...
	protected Column<Task, ?> createColumn() {
		return new TextColumn<Task>() {
			...
			public String getValue(Task task) {
				return stringValueDate(task.getModificationDate());
			}
		};
	}
